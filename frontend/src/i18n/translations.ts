export const translations = {
  en: {
    ...
    register: {
      ...
      passwordHasSpace: "Password must not contain spaces.",
      orContinueWith: "Or continue with",
    },
  ...
  ru: {
    ...
    register: {
      ...
      passwordNoLower: "Пароль должен содержать хотя бы одну строчную букву.",
      passwordNoDigit: "Пароль должен содержать хотя бы одну цифру.",
      passwordHasSpace: "Пароль не должен содержать пробелы.",
