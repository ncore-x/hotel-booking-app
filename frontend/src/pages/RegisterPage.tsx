...
export function RegisterPage() {
  const { error, clearError, register, loginWithOAuth } = useAuthStore();
      ...
      <div className="flex flex-1 items-center justify-center bg-surface px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="mt-6 flex items-center gap-3">
            ...
            <span className="text-xs text-muted">{t.register.orContinueWith}</span>
            <div className="h-px flex-1 bg-divider" />
          </div>
          ...
          <div className="mt-4 flex flex-col gap-3">
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-xl border border-divider bg-card py-2.5 text-sm font-medium text-ink transition-colors hover:bg-secondary"
            >
